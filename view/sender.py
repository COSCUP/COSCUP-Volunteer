    ...
    if request.method == 'GET':
        ...
        if 'casename' in data and data['casename'] == 'get':
            ...
            for uid in raw_users_info:
                users_info[uid] = {
                    'uid': uid,
                    'name': raw_users_info[uid]['profile']['badge_name']
                }
...
@VIEW_SENDER.route('/<pid>/<tid>/campaign/<cid>/content',
                   methods=('GET', 'POST'))
...
@VIEW_SENDER.route('/<pid>/<tid>/campaign/<cid>/receiver',
                   methods=('GET', 'POST'))
...
@VIEW_SENDER.route('/<pid>/<tid>/campaign/<cid>/schedule',
                   methods=('GET', 'POST'))
