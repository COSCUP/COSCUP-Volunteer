...
完整的[財務流程](../secretary_team/tasks/accounting_system.md)也初步擬定，在未來也會繼續逐步實作每一階段！
...
平台也在找夥伴一起投入讓「志工平台」更好，如果對於[行政組](../secretary_team/overview.md)或是「[志工服務平台](../index.md)」有興趣，可以看看前述所提到的連結。

## 行政組招募

以上關於平台的回顧與介紹都只是行政組業務的一小塊部分。行政組依任務分出三個小組來分工：庶務組、開發組、招募組。各小組也持續朝著支持大會活動的方向發展，並找尋志同道合的夥伴一起努力。

詳細的招募資訊可以參考「[簡介與招募](../secretary_team/recruit.md)」，若覺得行政組好像很好玩，也想一起加入 2023 的籌備團隊，也非常歡迎！
